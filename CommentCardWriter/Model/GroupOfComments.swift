...
class GroupOfComments {
    ...
    static func createGroupOfComments(date: Date, of size: Int = 3) -> GroupOfComments{
        ...
        let exampleSubjectsAndCodes: [(String,String)] = [("Maths","MCW-1"),("Computer Science","vCX-1"),("Physics","pCZ-1"),("English","eCY-1"),("Biology","bCA-1"),("Chemistry","cCB-1"),("Spanish","sCV-1"),("French","fCU-1")]
    ...
    static let examples = [GroupOfComments.createGroupOfComments(date: Date()),
                           GroupOfComments.createGroupOfComments(date: Date()),
                           GroupOfComments.createGroupOfComments(date: Date())]
    #endif
}
